...
/**
This CA certificate is not used in the sample, but it was used to sign the server certificate below.
The certificate portion (ln 10-35) can be used to validate server certificate on client side.
*/
